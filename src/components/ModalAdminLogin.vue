      ...
      <div class="p-5 space-y-4">
        ...
        <div class="p-3 bg-emerald-950/50 border border-emerald-700/40 rounded-xl text-left space-y-1.5">
          <div class="flex items-center gap-1.5 text-emerald-400 text-xs font-bold">
            ...
            <span>Autentikasi Google Resmi</span>
          </div>
          <p class="text-[11px] text-slate-300 leading-relaxed">
            Hanya akun Google resmi yang terdaftar sebagai <b>Admin / Operator LPNU PCNU Sumenep</b> (<code class="text-amber-300">@lpnu-sumenep.or.id</code> atau pengurus terverifikasi) yang dapat mengakses area ini.
          </p>
          <p class="text-[10px] text-slate-400 leading-relaxed">
            Pelaku UMKM tidak diizinkan masuk ke area admin dan dipersilakan masuk melalui pintu utama aplikasi.
          </p>
        </div>
